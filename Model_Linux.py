...
def create_test_data(train_csv_table, data_size=20, move_back=False):
    new_stage2 = '/home/student/E/{}/new_stage2'.format(data_dir)
    sample_images = '/home/student/E/{}/new_stage2/sample_images'.format(data_dir)
    input_labels = '/home/student/E/{}/input/stage1_labels_train.csv'.format(data_dir)
    new_stage_labels = '/home/student/E/{}/new_stage2/new_stage2_labels.csv'.format(data_dir)
    ...
    for patient in valid_csv_table.id:
        if not os.path.exists(os.path.join(sample_images, patient)):
            src = '/home/student/E/{}/input/sample_images/{}'.format(data_dir, patient)
            dst = sample_images
            shutil.move(src, dst)
    ...
    if move_back:
        for patient in os.listdir(sample_images):
            ...
            dst = '/home/student/E/{}/input/sample_images'.format(data_dir)
            shutil.move(src, dst)

    print(len(os.listdir('/home/student/E/{}/input/sample_images'.format(data_dir))))
    print(len(os.listdir(sample_images)))


train_csv_table = pd.read_csv('/home/student/E/{}/input/stage1_labels.csv'.format(data_dir))
...
for patient in train_patients:
    slices_path = glob.glob('/home/student/E/{}/input/sample_images/{}/*dcm'.format(data_dir, patient))
...
def create_model_and_plots():
    ...
    train_files = []
    for patient in train_patients:
        train_files += glob.glob('/home/student/E/{}/input/sample_images/{}/*dcm'.format(data_dir, patient))
    print('Number of train files: {}'.format(len(train_files)))

    valid_files = []
    for patient in valid_patients:
        valid_files += glob.glob('/home/student/E/{}/input/sample_images/{}/*dcm'.format(data_dir, patient))
...
def create_submission_model(model):
    sample_subm = pd.read_csv(r'/home/student/E/{}/new_stage2/new_stage2_labels.csv'.format(data_dir))
    ids = sample_subm['id'].values
    for id in ids:
        print('Predict for patient: {}'.format(id))
        files = glob.glob(r'/home/student/E/{}/new_stage2/sample_images/{}/*.dcm'.format(data_dir, id))
        image_list = []
        for f in files:
